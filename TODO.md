...
- [x] ~~클라우드 프로젝트 동기화~~ (MVP/2/3단계 + 자동 스케줄 동기화 완료, Day 53)

### 성능 개선
- [x] ~~파이썬 코어 로직 Cython 변환~~ (`time_utils`, `ducking_service`, `waveform_service`, Day 54)
- [x] ~~자막 렌더링 최적화~~ (Day 47 완료)
- [x] ~~프로젝트 파일 압축~~ (안정화+계측 스프린트 완료, Day 48)
- [x] ~~FFmpeg 프로세스 강제 종료 및 누수 방지~~ (안정성 강화, Day 54)
